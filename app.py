"""Streamlit app — guess the model from ACF/PACF plots.

Run with::

    streamlit run webapp/app.py

Two project tracks live in this directory; this is the *webapp* track and
deliberately does not import from the assignment ``src/`` package.
"""
...
from plots import acf_pacf_fig, series_fig  # noqa: E402
from simulators import FAMILY_OF, SIMULATORS, families, random_round  # noqa: E402

st.set_page_config(page_title="Volatility model trainer", layout="wide")
...
score_col1, score_col2, score_col3 = st.columns([1, 1, 4])
with score_col1:
...
returns_available = result.target_sq is not None  # squared exists ⇒ raw is a returns series
